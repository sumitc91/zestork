...
namespace zestork.Service.twitter
{
    public class oAuthTwitter : OAuthBase
    {
        ...
        public string ConsumerKey
        {
            get
            {
                ...
                {
                    _consumerKey = ConfigurationManager.AppSettings["twitterAppID"];
                }
                return _consumerKey;
            }
        ...
        public string ConsumerSecret
        {
            get
            {
                ...
                {
                    _consumerSecret = ConfigurationManager.AppSettings["twitterAppSecret"];
                }
